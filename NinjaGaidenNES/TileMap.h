...
#define STAGE3_1_MATRIXFILE "Resource/Stage3-1_matrixmap.txt"
#define STAGE3_2_MATRIXFILE "Resource/Stage3-2_matrixmap.txt"
#define STAGE3_3_MATRIXFILE "Resource/Stage3-3_matrixmap.txt"
